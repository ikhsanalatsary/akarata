      ...
      describe('at the begining', () => {
        describe('followed by a vowel, should remove and substitute the last character', () => {
          it("'meny'", () => {
            ...
            ShouldTransform(removeFirstOrderPrefix, 'menyanyi', 'nyanyi');
            ShouldTransform(removeFirstOrderPrefix, 'menyala', 'nyala');
            ShouldTransform(removeFirstOrderPrefix, 'menyata', 'nyata');
          });
          ...
          it("'peny'", () => {
            ...
            ShouldTransform(removeFirstOrderPrefix, 'penyanyi', 'nyanyi');
          });
        });
